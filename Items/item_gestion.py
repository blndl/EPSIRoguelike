...
class Item(BaseEntity):
    def __init__(self, item_id, description, price, moral, energy, itemshop, consommable, img):
    ...
    def load_items(cls, file_path):
        ...
        return {item_id: cls(
            item_id, item_data['description'], item_data['price'], item_data['moral'], item_data['energy'], item_data['itemshop'], item_data['consommable'], item_data.get('image', 'Items/Sprites/luckyblock.png'))
